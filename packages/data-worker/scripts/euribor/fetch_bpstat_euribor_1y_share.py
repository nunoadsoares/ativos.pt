#!/usr/bin/env python3
"""
Extrai a percentagem de novos créditos à habitação indexados à Euribor 1Y
e grava em packages/webapp/public/data/euribor_1y_share.csv
"""
...
OUTFILE    = (
    Path(__file__)
    .parents[3] / "webapp" / "public" / "data" / "euribor_1y_share.csv"
)
...
def main() -> None:
    ...
    sel = (
        ...
        & (df["Prazo de fixação inicial da taxa"] == "1 ano")
    )
