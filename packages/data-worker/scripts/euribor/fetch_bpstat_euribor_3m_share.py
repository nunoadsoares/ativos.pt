#!/usr/bin/env python3
"""
Extrai a percentagem de novos créditos à habitação indexados à Euribor 3M
e grava em packages/webapp/public/data/euribor_3m_share.csv
"""
...
OUTFILE    = (
    Path(__file__)
    .parents[3] / "webapp" / "public" / "data" / "euribor_3m_share.csv"
)
...
def main() -> None:
    ...
    sel = (
        ...
        & (df["Prazo de fixação inicial da taxa"] == "3 meses")
    )
